...
void internalEziUserIDCallback(const char* data)
{
                                           ...
                                           cocos2d::CCDictionary *dataDictionary)
{
    ...
    CCLOG("Data String = %s", dataString.c_str());
    CCLOG("Friends = %s", friendsString.c_str());
                                         ...
                                         bool forceDownload)
{
    ...
    CCLOG("Download URL = %s", downloadURL.c_str());
